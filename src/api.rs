...
pub mod public_api {
    ...
    impl HostSide {
        ...
        pub fn new() -> HostSide {
            HostSide { host: std::cell::RefCell::new(RemoteHostSide { host_plugin: ctypes::sag_plugin_t{r#plugin: std::ptr::null_mut()}, send_fn: Option::None}) }
        }
...
pub mod data_conversion {
    ...
    // creates and returns a deep copy of the C data structure
